...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `users` (`id`,`username`,`password`) VALUES (?,?,?)";
      }
    ...
    this.__preparedStmtOfUpdatePassword = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE users SET password = ? WHERE username = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object updatePassword(final String username, final String newPassword,
