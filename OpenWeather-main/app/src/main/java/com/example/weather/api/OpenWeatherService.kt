/**
 * This is a Retrofit service interface used to communicate with the OpenWeather API.
 * Provides a hanging function loadFiveDayForecast for obtaining 5-day/3-hour weather forecast data.
 * Use Moshi for JSON data parsing.
 * Contains a create method for creating an OpenWeatherService instance.
*/

package com.example.weather.api

import com.example.weather.data.FiveDayForecast
import com.example.weather.data.OpenWeatherCityJsonAdapter
import com.example.weather.data.OpenWeatherListJsonAdapter
...
interface OpenWeatherService {
     ...
     *
     * @param location Specifies the location for which to fetch forecast data.
