/**
 * Contains the ForecastPeriod data class that represents a single weather forecast period.
 * Defines related classes and adapters for parsing JSON data returned by the OpenWeather API.
 */
