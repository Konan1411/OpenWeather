/**
 * Fragment showing details of a single weather forecast.
 * Get forecast data from navigation parameters and update UI.
 * Provides ways to share forecast information.
 */
...
import com.example.weather.util.getTempUnitsDisplay
import com.example.weather.util.getWindSpeedUnitsDisplay
import com.example.weather.util.openWeatherEpochToDate

const val EXTRA_FORECAST_PERIOD = "com.example.android.weather.FORECAST_PERIOD"
const val EXTRA_FORECAST_CITY = "com.example.android.weather.FORECAST_CITY"
