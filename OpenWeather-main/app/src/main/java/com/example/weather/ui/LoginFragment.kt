...
class LoginFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val usernameEditText = view.findViewById<EditText>(R.id.textInputEmail)
        val passwordEditText = view.findViewById<EditText>(R.id.textInputPassword)
        val loginButton = view.findViewById<Button>(R.id.cirLoginButton)
        val signUpButton = view.findViewById<Button>(R.id.cirSignLink)
