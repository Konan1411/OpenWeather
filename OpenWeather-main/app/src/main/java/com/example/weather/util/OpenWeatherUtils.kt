/**
 * Contains utility functions for processing OpenWeather API data.
 * Provides functions for converting timestamps to dates, as well as functions for displaying temperature and wind speed in terms of units.
 */
